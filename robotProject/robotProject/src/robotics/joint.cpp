    ...
    , m_alpha(alpha)
{
    ...
    if (m_a != 0)
    {
        ...
        m_linkA->m_mesh->setRadius(m_LINK_RADIUS);
        m_linkA->m_material->setDiffuse(m_LINK_COLOR);
    }
    ...
    if (m_d != 0)
    {
        ...
        m_linkD->m_mesh->setRadius(m_LINK_RADIUS);
        m_linkD->m_material->setDiffuse(m_LINK_COLOR);
    }
